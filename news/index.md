...
- [`r()`](https://callr.r-lib.org/reference/r.md),
  ...
  [`rscript()`](https://callr.r-lib.org/reference/rscript.md) and
...
- [`r_bg()`](https://callr.r-lib.org/reference/r_bg.md) (and
  [`r()`](https://callr.r-lib.org/reference/r.md)) subprocesses now exit
  with a non-zero status when the evaluated expression throws an error
  or is interrupted, instead of always exiting with status 0
...
- callr is now instrumented with
  ...
  [`r()`](https://callr.r-lib.org/reference/r.md),
  [`rcmd()`](https://callr.r-lib.org/reference/rcmd.md),
  [`rscript()`](https://callr.r-lib.org/reference/rscript.md),
...
- New function
  [`add_hook()`](https://callr.r-lib.org/reference/add_hook.md) to hook
  into the callr process startup and options. This is for experts and it
  is also currently experimental
...
- [`callr::r_session`](https://callr.r-lib.org/reference/r_session.md)
...
- [`r()`](https://callr.r-lib.org/reference/r.md),
  [`rcmd()`](https://callr.r-lib.org/reference/rcmd.md) and
  [`rscript()`](https://callr.r-lib.org/reference/rscript.md) can now
  redirect the standard error of the subprocess its standard output.
...
- [`r()`](https://callr.r-lib.org/reference/r.md),
  [`rcmd()`](https://callr.r-lib.org/reference/rcmd.md) and
  [`rscript()`](https://callr.r-lib.org/reference/rscript.md) now pass
  `...` arguments to
  [`processx::run()`](http://processx.r-lib.org/reference/run.md).
  [`r_bg()`](https://callr.r-lib.org/reference/r_bg.md) and
  [`rcmd_bg()`](https://callr.r-lib.org/reference/rcmd_bg.md) pass `...`
  arguments to the
...
- [`r()`](https://callr.r-lib.org/reference/r.md),
  [`r_bg()`](https://callr.r-lib.org/reference/r_bg.md), etc. now handle
  messages from the cliapp package properly. They used to make the R
  session exit.
...
- New [`rscript()`](https://callr.r-lib.org/reference/rscript.md)
...
- callr users `.Renviron` files now (and `R_ENVIRON_USER` as well), but
  ...
  [`r()`](https://callr.r-lib.org/reference/r.md), etc.
...
- Run R or `R CMD` in the background, see
  [`r_bg()`](https://callr.r-lib.org/reference/r_bg.md),
  [`rcmd_bg()`](https://callr.r-lib.org/reference/rcmd_bg.md), and also
  `r_process` and `rcmd_process`

- The defaults for [`r()`](https://callr.r-lib.org/reference/r.md) are
  safer now, the match the defaults of
  [`r_safe()`](https://callr.r-lib.org/reference/r.md).
  [`r_safe()`](https://callr.r-lib.org/reference/r.md) is kept for
  compatibility.
  [`r_copycat()`](https://callr.r-lib.org/reference/r_copycat.md) has
  the old [`r()`](https://callr.r-lib.org/reference/r.md) defaults.

- The defaults for [`rcmd()`](https://callr.r-lib.org/reference/rcmd.md)
  are safer now, the match the defaults of
  [`rcmd_safe()`](https://callr.r-lib.org/reference/rcmd.md).
  [`rcmd_safe()`](https://callr.r-lib.org/reference/rcmd.md) is kept for
  compatibility.
  [`rcmd_copycat()`](https://callr.r-lib.org/reference/rcmd_copycat.md)
  has the old [`rcmd()`](https://callr.r-lib.org/reference/rcmd.md)
  defaults.
...
- Add `spinner` argument to show a spinner in
  [`r()`](https://callr.r-lib.org/reference/r.md) or
  [`rcmd()`](https://callr.r-lib.org/reference/rcmd.md)
...
- [`rcmd()`](https://callr.r-lib.org/reference/rcmd.md) gets a
  `fail_on_status` argument

- [`rcmd()`](https://callr.r-lib.org/reference/rcmd.md) gets an `echo`
  argument to potentially show the command to be run on the screen
  ([\#15](https://github.com/r-lib/callr/issues/15))

- [`rcmd()`](https://callr.r-lib.org/reference/rcmd.md) gets a `wd`
