...
Similar to [`r()`](https://callr.r-lib.org/reference/r.md), but runs the
function in a permanent background R session. It throws an error if the
function call generated an error in the child process.
