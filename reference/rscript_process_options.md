# Create options for an [rscript_process](https://callr.r-lib.org/reference/rscript_process.md) object
...
[`rscript()`](https://callr.r-lib.org/reference/rscript.md) function. At
least the `script` option must be specified, the script file to run.
