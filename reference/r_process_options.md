# Create options for an [r_process](https://callr.r-lib.org/reference/r_process.md) object

Create options for an
[r_process](https://callr.r-lib.org/reference/r_process.md) object
...
arguments of the [`r()`](https://callr.r-lib.org/reference/r.md)
...
#>  [4] "    }\n"                                                                                                           
#>  [5] "    env <- readRDS(\"/tmp/RtmpwCOwOw/callr-env-1e467ba396c0\")\n"                                                  
