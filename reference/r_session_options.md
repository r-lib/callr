# Create options for an [r_session](https://callr.r-lib.org/reference/r_session.md) object

Create options for an
[r_session](https://callr.r-lib.org/reference/r_session.md) object
...
- `cmdargs`: See the same argument of
  [`r()`](https://callr.r-lib.org/reference/r.md). (Its default might be
  different, though.)
