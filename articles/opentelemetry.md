...
([`r()`](https://callr.r-lib.org/reference/r.md), `r_session$new()`,
[`rcmd()`](https://callr.r-lib.org/reference/rcmd.md),
[`rscript()`](https://callr.r-lib.org/reference/rscript.md)) start
...
|----|----|
| [`callr::r`](https://callr.r-lib.org/reference/r.md) | [`r()`](https://callr.r-lib.org/reference/r.md) |
| [`callr::rscript`](https://callr.r-lib.org/reference/rscript.md) | [`rscript()`](https://callr.r-lib.org/reference/rscript.md) |
| [`callr::rcmd`](https://callr.r-lib.org/reference/rcmd.md) | [`rcmd()`](https://callr.r-lib.org/reference/rcmd.md) |
| [`callr::r_process`](https://callr.r-lib.org/reference/r_process.md) | `r_process$new()` / [`r_bg()`](https://callr.r-lib.org/reference/r_bg.md) (ends in `$get_result`) |
| [`callr::r_session`](https://callr.r-lib.org/reference/r_session.md) | `r_session$new()` (ends in `$close()` or finalizer) |
...
Sessions](https://callr.r-lib.org/articles/r-session.md) article for the
full list).
...
```
    ...
    #>                          name           parent
    #> 1              r_session$read acd0db31129f7266
    #> 2 r_session$initialize() wait acd0db31129f7266
    #> 3              r_session$call acd0db31129f7266
    #> 4              r_session$read acd0db31129f7266
    #> 5            callr::r_session 0000000000000000
    #> 6             r_session$close acd0db31129f7266
...
```
    ...
    #> [1] "00-58ebe5f6b0f7aecee2501b61b4b93af3-fa7ed46897993daf-01"
...
[`callr::r`](https://callr.r-lib.org/reference/r.md) span.
