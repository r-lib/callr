...
```
    ...
    #>                          name           parent
    #> 1              r_session$read 98be582e5fa8d949
    #> 2 r_session$initialize() wait 98be582e5fa8d949
    #> 3              r_session$call 98be582e5fa8d949
    #> 4              r_session$read 98be582e5fa8d949
    #> 5            callr::r_session 0000000000000000
    #> 6             r_session$close 98be582e5fa8d949
...
```
    ...
    #> [1] "00-1d62e64651cff883e482c2bbede379db-ad82c51ad903ec93-01"
