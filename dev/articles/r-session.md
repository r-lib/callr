...
is a class for a persistent R session that runs in the background and
you can send commands to it. It extends the
...
```
    ...
    #> R SESSION, alive, idle, pid 10002.                                              
...
```
    ...
    #> R SESSION, alive, starting, pid 10013.                                          
...
```
    ...
    #> [1] 0.311626 0.311626 0.311626 0.311626                                         
...
```
    ...
    #>                                                                                 
    #> $message                                                                        
    #> [1] "done callr-rs-result-270975e2eefa"                                         
    #>                                                                                 
    #> $result                                                                         
...
```
    ...
    #> [[1]]                                                                           
    #> R SESSION, alive, busy, pid 10033.                                              
    #>                                                                                 
    #> [[2]]                                                                           
    #> R SESSION, alive, busy, pid 10035.                                              
    #>                                                                                 
    #> [[3]]                                                                           
    #> R SESSION, alive, busy, pid 10040.                                              
    #>                                                                                 
    #> [[4]]                                                                           
    #> R SESSION, alive, busy, pid 10045.                                              
    #>                                                                                 
...
```
    ...
    #>                                                                                 
    #> $message                                                                        
    #> [1] "done callr-rs-result-2709553ecf44"                                         
    #>                                                                                 
    #> $result                                                                         
    #> I am process 10045.                                                             
    #>                                                                                 
...
```
    ...
    #>                                                                                 
    #> $message                                                                        
    #> [1] "done callr-rs-result-270910b2f9f8"                                         
    #>                                                                                 
    #> $result                                                                         
    #> I am process 10033.                                                             
    #>                                                                                 
    ...
    #>                                                                                 
    #> $message                                                                        
    #> [1] "done callr-rs-result-27097009a33d"                                         
    #>                                                                                 
    #> $result                                                                         
    #> I am process 10035.                                                             
    #>                                                                                 
    ...
    #>                                                                                 
    #> $message                                                                        
    #> [1] "done callr-rs-result-27095587266f"                                         
    #>                                                                                 
    #> $result                                                                         
    #> I am process 10040.                                                             
    #>                                                                                 
...
```
    ...
    #>                                                                                 
    #> $message                                                                        
    #> [1] "done callr-rs-result-270932fcc3c0"                                         
    #>                                                                                 
    #> $result                                                                         
    #> NULL                                                                            
    #>                                                                                 
