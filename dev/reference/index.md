...
- [`callr`](https://callr.r-lib.org/dev/reference/callr-package.md)
  [`callr-package`](https://callr.r-lib.org/dev/reference/callr-package.md)
  : Call R from R

## Run R

- [`r()`](https://callr.r-lib.org/dev/reference/r.md)
  [`r_safe()`](https://callr.r-lib.org/dev/reference/r.md) : Evaluate an
...
- [`r_bg()`](https://callr.r-lib.org/dev/reference/r_bg.md) : Evaluate
  an expression in another R session, in the background
- [`r_process`](https://callr.r-lib.org/dev/reference/r_process.md) :
  External R Process
- [`r_process_options()`](https://callr.r-lib.org/dev/reference/r_process_options.md)
  : Create options for an r_process object

## Persistent background R session

- [`r_session`](https://callr.r-lib.org/dev/reference/r_session.md) :
  External R Session
...
- [`rcmd_safe_env()`](https://callr.r-lib.org/dev/reference/rcmd_safe_env.md)
  ...
  appropriate for
  [`rcmd_safe()`](https://callr.r-lib.org/dev/reference/rcmd.md). It is
  exported to allow manipulating these variables (e.g. add an extra
  one), before passing them to the
  [`rcmd()`](https://callr.r-lib.org/dev/reference/rcmd.md) functions.

## Run R CMD in the background

- [`rcmd_bg()`](https://callr.r-lib.org/dev/reference/rcmd_bg.md) :
...
- [`rscript()`](https://callr.r-lib.org/dev/reference/rscript.md) : Run
  an R script
...
- [`add_hook()`](https://callr.r-lib.org/dev/reference/add_hook.md) :
  Add a user hook to be executed before launching an R subprocess

## Re-exported functions

- [`reexports`](https://callr.r-lib.org/dev/reference/reexports.md)
  [`run`](https://callr.r-lib.org/dev/reference/reexports.md)
  [`process`](https://callr.r-lib.org/dev/reference/reexports.md)
  [`poll`](https://callr.r-lib.org/dev/reference/reexports.md) : Objects
