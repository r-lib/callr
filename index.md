...
Use [`r()`](https://callr.r-lib.org/reference/r.md) to run an R function
in a new R process. The results are passed back seamlessly:
...
[`r_bg()`](https://callr.r-lib.org/reference/r_bg.md) is similar to
[`r()`](https://callr.r-lib.org/reference/r.md) but it starts the R
...
[`get_result()`](https://callr.r-lib.org/reference/get_result.md)
...
- [`get_result()`](https://callr.r-lib.org/reference/get_result.md) to
  collect the return value of the R function call.
...
session. `r_session$call()` starts the function call and returns
immediately. The `r_session$poll_process()` method or
...
```
    ...
    #>  [1] 0.9192300 0.5582434 0.6119445 0.5589570 0.7143346 0.6170600 0.1706850
    #>  [8] 0.8547807 0.2258252 0.0556730
...
```
    ...
    #>
    #> $message
    #> [1] "done callr-rs-result-1e3b60a8b567"
    #>
    #> $result
    #>  [1] -0.95943577  0.07595167  0.87498381  1.16226111  0.24285904 -0.78426823
    #>  [7]  1.44413806  0.84342995 -1.77001167  2.04951812
    #>
    #> $stdout
    #> [1] ""
    #>
...
The [`rcmd()`](https://callr.r-lib.org/reference/rcmd.md) function calls
an `R CMD` command. For example, you can call `R CMD INSTALL`,
...
See
[`vignette("opentelemetry", package = "callr")`](https://callr.r-lib.org/articles/opentelemetry.md)
